...
public class DropDownListView extends ListView implements OnScrollListener {
	...
	//用于判断拉动的方向true为下拉刷新，false 为上拉刷新
	private boolean dropStatus = true;
	...
	public void setMyClickListener(OnClickListener myClickListener) {
		...
		footerView.setOnClickListener(this.myClickListener);
	}

	public void changeFooterVisibility(boolean visible){
		if(!visible){
			footerView.setVisibility(View.GONE);
			footerView.setPadding(0, footerContentHeight, 0, -2*footerContentHeight);
		}else{
...
//		footertipsTextview = (TextView) footerView.findViewById(R.id.footer_tipsTextView);
//		measureView(footerView);
//		footerContentHeight = footerView.getMeasuredHeight();
//		footerContentWidth = footerView.getMeasuredWidth();
//		footerView.setPadding(0, footerContentHeight, 0, -2*footerContentHeight);
//		footerView.invalidate();
//		Log.v("footersize", "width:" + footerContentWidth + " height:"
//				+ footerContentHeight);
