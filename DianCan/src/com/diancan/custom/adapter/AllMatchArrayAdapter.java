...
public class AllMatchArrayAdapter<T> extends BaseAdapter implements Filterable {
    ...
    public SearchAdapterHelper getmAdapterHelper() {
		return mAdapterHelper;
	}

	public void setmAdapterHelper(SearchAdapterHelper mAdapterHelper) {
    ...
    public View createViewFromResource(int position, View convertView, ViewGroup parent,
        ...
        try {
            ...
            priceView = (TextView)view.findViewById(R.id.recipePrice);
    ...
    private class ArrayFilter extends Filter {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            if (results.count > 0) {
                notifyDataSetChanged();
                mAdapterHelper.SetListViewHeight(results.count);
            } else {
